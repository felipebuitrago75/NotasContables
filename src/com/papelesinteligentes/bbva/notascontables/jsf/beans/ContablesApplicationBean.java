...
public class ContablesApplicationBean extends AbstractApplicationBean {
	 ...
	 * </p>
	 */
	public ContablesApplicationBean() {
	}

	/**
	 * <p>
	 * This method is called when this bean is initially added to application scope. Typically, this occurs as a result of evaluating a value binding or method binding expression, which utilizes the managed bean facility to instantiate this bean and
	 * store it into application scope.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Return an appropriate character encoding based on the <code>Locale</code> defined for the current JavaServer Faces view. If no more suitable encoding can be found, return "UTF-8" as a general purpose default.
	 * </p>
	 * 
	 * <p>
